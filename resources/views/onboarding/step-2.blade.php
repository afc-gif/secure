<x-onboarding.layout :step="$step" :completion="$completion">
    <x-onboarding.form-card
        eyebrow="Step 2"
        title="Disbursement Address Registry"
        description="Secure the residential address used for member records, cooperative correspondence, and future disbursement verification."
    >
