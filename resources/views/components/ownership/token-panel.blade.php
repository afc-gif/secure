<section {{ $attributes->merge(['class' => 'cca-card overflow-hidden']) }}>
    <div class="border-b border-white/10 px-5 py-5 sm:px-7">
        <p class="text-xs font-bold uppercase tracking-[0.24em] text-[#d4af62]">Secure Cooperative Access</p>
        <h2 class="mt-2 text-2xl font-black text-white">Unlock Ownership Access</h2>
