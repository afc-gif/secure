<x-dashboard.shell title="Member Portfolio" eyebrow="Verified Member Dashboard">
    ...
    <div class="grid gap-4 xl:grid-cols-[minmax(0,1fr)_18rem]">
        <section class="overflow-hidden rounded-lg border border-white/[0.07] bg-gradient-to-br from-[#7d4dff] via-[#d936ad] to-[#f34b8b] p-5 shadow-xl shadow-black/20 sm:p-7">
        ...
        <section class="grid gap-4 sm:grid-cols-2 xl:grid-cols-1">
            <div class="rounded-lg border border-white/[0.07] bg-[#101216] p-4 shadow-xl shadow-black/20">
            ...
            <div class="rounded-lg border border-white/[0.07] bg-[#101216] p-4 shadow-xl shadow-black/20">
                ...
                <div class="mt-4 rounded-md border border-emerald-300/15 bg-emerald-300/10 px-3 py-2 text-xs font-bold uppercase tracking-[0.12em] text-emerald-100">Active</div>
            </div>
        </section>

        <section class="rounded-lg border border-white/[0.07] bg-[#101216] p-4 shadow-xl shadow-black/20 sm:p-6 xl:col-span-1">
        ...
        <section class="rounded-lg border border-white/[0.07] bg-[#101216] p-4 shadow-xl shadow-black/20 sm:p-6 xl:row-span-2">
        ...
        <section class="grid gap-4 lg:grid-cols-[1fr_1fr]">
            <div class="rounded-lg border border-white/[0.07] bg-[#101216] p-4 shadow-xl shadow-black/20 sm:p-6">
                <div class="flex items-start justify-between gap-3">
                    <div class="min-w-0">
