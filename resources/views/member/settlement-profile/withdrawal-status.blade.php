<x-dashboard.shell title="Withdrawal Status" eyebrow="Member Payouts">
    ...
    <section class="mx-auto max-w-xl rounded-lg border border-white/[0.07] bg-[#101116]/95 p-6 text-center shadow-xl shadow-black/20 sm:p-8">
        @if ($isComplete)
            ...
            <p class="mt-3 text-sm leading-6 text-slate-400">Your withdrawal has been completed.</p>
        @else
            ...
            <p class="mt-3 text-sm leading-6 text-slate-400">Your withdrawal will be complete within 24hrs.</p>
        @endif
