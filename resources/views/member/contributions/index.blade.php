<x-dashboard.shell title="Ownership contributions" eyebrow="Cooperative Ledger">
    ...
    <div class="mt-6 grid gap-5 xl:grid-cols-[1.25fr_0.75fr]">
        <section class="cca-card overflow-hidden">
            <div class="flex flex-col gap-3 border-b border-white/[0.07] bg-white/[0.015] px-5 py-4 sm:flex-row sm:items-center sm:justify-between">
                <div>
        ...
        <section class="space-y-4">
            <div class="cca-card p-5">
                ...
                <div class="mt-5 h-2 rounded-full bg-white/10">
                    <div class="h-2 rounded-full bg-gradient-to-r from-[#7c3cff] via-[#d936ad] to-[#f35f8d]" style="width: {{ min(100, max(4, $summary['ownership_percentage'])) }}%"></div>
                </div>
            ...
            <div class="cca-card p-5">
                ...
                <div class="mt-4 space-y-3">
                    @forelse ($recentActivity as $activity)
                        <div class="rounded-lg border border-white/[0.07] bg-[#0b0d10]/70 p-3">
